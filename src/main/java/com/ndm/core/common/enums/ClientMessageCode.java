...
public enum ClientMessageCode {
    REQUEST_RECEIVED("요청을 받았습니다.", "상대방의 프로필을 확인해주세요.", USER),
    REQUEST_REJECTED("요청이 거절되었습니다.", "", USER),
    REQUEST_ACCEPTED("상대방이 요청을 수락했어요!", "상대방의 사진을 확인하고 매칭을 완료해주세요.", USER),
    U_MATCHING_SUCCESS("상대방도 소개 받기를 원해요!", "상대방의 주선자에게 번호를 요청했습니다. 잠시만 기다려주세요.", USER),
    MATCHING_CANCEL("상대방이 매칭을 취소했습니다.", "", USER),
